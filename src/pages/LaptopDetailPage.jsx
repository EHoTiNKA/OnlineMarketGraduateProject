...
const LaptopDetailPage = () => {
  ...
  const handleBuyNow = () => {
    ...
    alert(`Переход к оформлению заказа на "${laptop.model_name}" (${quantity} шт.)`);
  };
        ...
        <div className="laptopDetailRight">
          <div className="laptopDetailHeader">
            ...
            <div className="laptopDetailManufacturer">
              <span className="laptopDetailManufacturerLabel">Производитель:</span>
            ...
            <div className="laptopDetailAvailability">
              {laptop.is_available ? (
                <div className="laptopDetailInStock">
                  <span className="laptopDetailStockStatus available">В наличии</span>
                  <span className="laptopDetailStockCount">
                    {laptop.stock_quantity > 10 ? "Много" : `Осталось ${laptop.stock_quantity} шт.`}
                  </span>
                </div>
              ) : (
                <span className="laptopDetailStockStatus unavailable">Нет в наличии</span>
              )}
            </div>
          </div>
            ...
            <div className="laptopDetailPurchaseSection">
              <div className="laptopDetailQuantity">
                ...
                <div className="laptopDetailQuantityControls">
                  ...
                  <button 
                    className="laptopDetailQuantityBtn"
                    onClick={() => setQuantity(prev => Math.min(laptop.stock_quantity, prev + 1))}
                ...
                <>
                  {laptop.specs.processor && (
                    <div className="laptopDetailSpecItem">
                      ...
                      <span className="laptopDetailSpecValue">
                        {laptop.specs.processor.model_name} ({laptop.specs.processor.cores} ядер, {laptop.specs.processor.threads} потоков)
                      </span>
                    </div>
                  )}
                  ...
                  {laptop.specs.graphic && (
                    <div className="laptopDetailSpecItem">
                      ...
                      <span className="laptopDetailSpecValue">
                        {laptop.specs.graphic.model_name} ({laptop.specs.graphic.memory} GB)
                      </span>
                    </div>
                  )}
                  ...
                  {laptop.specs.ram && (
                    <div className="laptopDetailSpecItem">
                      <span className="laptopDetailSpecLabel">Оперативная память:</span>
                      <span className="laptopDetailSpecValue">
                        {laptop.specs.ram.size} GB {laptop.specs.ram.type} ({laptop.specs.ram.frequency})
                      </span>
                    </div>
                  )}
                  ...
                  {laptop.specs.storage && (
                    <div className="laptopDetailSpecItem">
                      ...
                      <span className="laptopDetailSpecValue">
                        {laptop.specs.storage.capacity} GB {laptop.specs.storage.type} ({laptop.specs.storage.interface})
                      </span>
                    </div>
                  )}
                  ...
                  {laptop.specs.screen && (
                    <div className="laptopDetailSpecItem">
                      ...
                      <span className="laptopDetailSpecValue">
                        {laptop.specs.screen.diagonal}" {laptop.specs.screen.resolution} ({laptop.specs.screen.matrix_type}, {laptop.specs.screen.refresh_rate}Hz)
                      </span>
                    </div>
                  )}
                  ...
                  {laptop.specs.os_name && (
                    <div className="laptopDetailSpecItem">
                      <span className="laptopDetailSpecLabel">Операционная система:</span>
                      <span className="laptopDetailSpecValue">
                        {laptop.specs.os_name}
                      </span>
                    </div>
                  ...
                  {laptop.specs.material && (
                    <div className="laptopDetailSpecItem">
                      <span className="laptopDetailSpecLabel">Материал корпуса:</span>
                      <span className="laptopDetailSpecValue">
                        {laptop.specs.material}
                      </span>
                    </div>
                  ...
                  {laptop.specs.keyboard_light !== undefined && (
                    <div className="laptopDetailSpecItem">
                      <span className="laptopDetailSpecLabel">Подсветка клавиатуры:</span>
                      <span className="laptopDetailSpecValue">
                  ...
                  {laptop.specs.back_light_color && (
                    <div className="laptopDetailSpecItem">
                      <span className="laptopDetailSpecLabel">Цвет подсветки:</span>
                      <span className="laptopDetailSpecValue">
                        {laptop.specs.back_light_color}
                      </span>
                    </div>
              ...
              <div className="laptopDetailWarehouseList">
                {laptop.warehouse_stock.map((stock) => (
                  <div key={stock.id} className="laptopDetailWarehouseItem">
                    <span className="laptopDetailWarehouseCity">{stock.city}:</span>
                    <span className="laptopDetailWarehouseQuantity">{stock.quantity} шт.</span>
                  </div>
                ))}
              </div>
            </div>
